-- CreateEnum
CREATE TYPE "public"."LeadStatus" AS ENUM ('NOT_QUALIFIED', 'MEDIUM', 'HIGH');
...
CREATE TABLE "public"."leads" (
    ...
    "budget" DECIMAL(15,2),
    "expectations" TEXT,
    "status" "public"."LeadStatus" NOT NULL DEFAULT 'NOT_QUALIFIED',
...
-- AddForeignKey
ALTER TABLE "public"."chat_history" ADD CONSTRAINT "chat_history_lead_id_fkey" FOREIGN KEY ("lead_id") REFERENCES "public"."leads"("id") ON DELETE SET NULL ON UPDATE CASCADE;
